...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" onclick="edittask(${index})" class="text-primary"><i class="fas fa-edit"></i>Edit</button></td>
                    <td><button type="button" class="text-success" id=${index}><i class="fas fa-check-square-o"></i>Complete</button></td>
