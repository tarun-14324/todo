...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    <td><button type="button" class="text-success" id=${index}><i ></i>Complete</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger"><i ></i>Delete</button></td>
                </tr>`;
    });
